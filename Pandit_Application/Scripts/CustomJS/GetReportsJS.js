    ...
    $.ajax({
        ...
        success: function (Res) {
            ...
            for (var i = 0; i < datares.length; i++) {
                ...
                tabstring += " <li style='display:inline'><a  href='/SpecialistServices/SpecialistServices?ID=" + datares[i].ReportID + "&PartnerFlag=" + datares[i].PartnerFlag + "&Name=" + datares[i].Reportname + " &Type=Report'>Get Report </a> </li>"
                tabstring += "  </ul>"
                tabstring += "</div>"
                tabstring += "</div>"
                tabstring += "</div>"
